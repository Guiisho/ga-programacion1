...
<div class="row justify-content-md-center mt-5">
    ...
    <div class="col-md-auto">
        ...
        <div class="mb-3 mt-3">
            ...
            <input v-model="correo" class='form-control' type="text" placeholder="Ingrese Correo">
        </div>
     

        <div class="mb-3">
            <label class="form-label">Contraseña</label>
            <input v-model="password" class='form-control' type="password" placeholder="Ingrese Contraseña">
         </div> 
